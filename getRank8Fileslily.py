...
result = client.query(f'SELECT "Filename","ranking" FROM "RankingInfo"') #works for "oldRanking" but not for this
...
# dfMerged['Ranking'] = dfMerged['Ranking'].astype(int) # ValueError: invalid literal for int() with base 10: '' ??
...
# was 0602 
dfFiltered = dfFiltered[dfFiltered['Date'] <= 20250816]
...
with open('rank8Fileslily.txt', mode='w', newline='') as file:
...
print("Rank 8 Files Data written to rank8Fileslily.txt")
